            ...
            <div className="card">
              ...
              {lastCreatedCode && (
                <div className={styles.createdCodeBox}>
                  ...
                  <p className={styles.createdCodeHint}>Participants do not need an account. They enter this code on the join page to get started. Open the session from the panel on the right.</p>
                </div>
              )}
